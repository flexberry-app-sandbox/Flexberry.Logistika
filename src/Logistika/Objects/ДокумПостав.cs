...
namespace IIS.Logistika
{
    ...
    [View("ДокумПоставE", new string[] {
            ...
            "Клиенты.АдресПостав as \'Адрес поставки\'",
    ...
    public class ДокумПостав : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika.Организация fОрганизация;
        
        private IIS.Logistika.Клиенты fКлиенты;
        
        private IIS.Logistika.DetailArrayOfТЧИнфОЗак fТЧИнфОЗак;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Logistika.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Logistika.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Logistika.Организация Организация
        {
            get
            {
                ...
                IIS.Logistika.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Logistika.DetailArrayOfТЧИнфОЗак ТЧИнфОЗак
        {
            get
            {
                ...
                {
                    this.fТЧИнфОЗак = new IIS.Logistika.DetailArrayOfТЧИнфОЗак(this);
                }
                IIS.Logistika.DetailArrayOfТЧИнфОЗак result = this.fТЧИнфОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставE", typeof(IIS.Logistika.ДокумПостав));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставL", typeof(IIS.Logistika.ДокумПостав));
                }
            }
        }
    }
