...
namespace IIS.Logistika
{
    ...
    public class ТЧИнфОЗак : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika.Товары fТовары;
        ...
        [PropertyStorage(new string[] {
                "Товары"})]
        [NotNull()]
        public virtual IIS.Logistika.Товары Товары
        {
            get
            {
                ...
                IIS.Logistika.Товары result = this.fТовары;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Logistika.ДокумПостав.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧИнфОЗакE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧИнфОЗакE", typeof(IIS.Logistika.ТЧИнфОЗак));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧИнфОЗак : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Logistika.DetailArrayOfТЧИнфОЗак members)

        // *** End programmer edit section *** (IIS.Logistika.DetailArrayOfТЧИнфОЗак members)
        ...
        /// </summary>
        public DetailArrayOfТЧИнфОЗак(IIS.Logistika.ДокумПостав fДокумПостав) : 
                base(typeof(ТЧИнфОЗак), ((ICSSoft.STORMNET.DataObject)(fДокумПостав)))
        {
        }
        
        public IIS.Logistika.ТЧИнфОЗак this[int index]
        {
            get
            {
                return ((IIS.Logistika.ТЧИнфОЗак)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Logistika.ТЧИнфОЗак dataobject)
        {
