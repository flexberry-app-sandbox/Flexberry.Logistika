...
namespace IIS.Logistika
{
    ...
    public class ФормирРезПос : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika.СтатусЗаказа fСтатусЗаказа;
        
        private bool fНаличиеДеф;
        
        private IIS.Logistika.УдовлКл fУдовлКл;
        
        private IIS.Logistika.ФормирРаспред fФормирРаспред;
        ...
        public virtual IIS.Logistika.СтатусЗаказа СтатусЗаказа
        {
            get
            {
                ...
                IIS.Logistika.СтатусЗаказа result = this.fСтатусЗаказа;
        ...
        public virtual IIS.Logistika.УдовлКл УдовлКл
        {
            get
            {
                ...
                IIS.Logistika.УдовлКл result = this.fУдовлКл;
        ...
        [PropertyStorage(new string[] {
                "ФормирРаспред"})]
        [NotNull()]
        public virtual IIS.Logistika.ФормирРаспред ФормирРаспред
        {
            get
            {
                ...
                IIS.Logistika.ФормирРаспред result = this.fФормирРаспред;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосE", typeof(IIS.Logistika.ФормирРезПос));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосL", typeof(IIS.Logistika.ФормирРезПос));
                }
            }
        }
    }
