...
namespace IIS.Logistika
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Logistika.ЕдИзм fЕдИзм;
        ...
        public virtual IIS.Logistika.ЕдИзм ЕдИзм
        {
            get
            {
                ...
                IIS.Logistika.ЕдИзм result = this.fЕдИзм;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Logistika.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Logistika.Товары));
                }
            }
        }
    }
